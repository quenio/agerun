...
1. **Run Tests**: Use `./clean_build.sh` for comprehensive build verification (~20 lines output) to ensure all changes work correctly and no memory leaks. **If clean build fails, STOP - do not proceed with commit until all issues are fixed.**
