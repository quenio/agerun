...
| workflow-methodology | How the bundled workflow methodology boots, validates definitions, evaluates item context for transitions, and emits visible logs | scaffolded | [Workflow Methodology](https://quenio.github.io/agerun/walkthroughs/workflow-methodology/index.html) |
