...
static void test_create_destroy(void) {
    ...
    ar_expression_evaluator_t *evaluator = ar_expression_evaluator__create(memory, NULL);
...
static void test_create_null_memory(void) {
    ...
    ar_expression_evaluator_t *evaluator = ar_expression_evaluator__create(NULL, NULL);
