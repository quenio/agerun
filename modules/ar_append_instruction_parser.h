#ifndef AGERUN_APPEND_INSTRUCTION_PARSER_H
#define AGERUN_APPEND_INSTRUCTION_PARSER_H
...
/**
 * Opaque parser structure for append instructions.
 * Handles parsing of append function calls like "append(memory.results, message.value)".
 */
typedef struct ar_append_instruction_parser_s ar_append_instruction_parser_t;

/**
 * Create a new append instruction parser instance.
...
/**
 * Destroy an append instruction parser instance.
 ...
 * @return Parsed append AST node (owned by caller), or NULL on failure
...
#endif /* AGERUN_APPEND_INSTRUCTION_PARSER_H */
