...
static void test_fixture_create_destroy(void) {
    printf("Testing ar_system_fixture_create() and ar_system_fixture_destroy()...\n");
    ...
    const char *retrieved_name = ar_system_fixture_get_name(own_fixture);
    ...
    printf("ar_system_fixture_create() and ar_system_fixture_destroy() tests passed!\n");
}

static void test_fixture_initialize(void) {
    printf("Testing ar_system_fixture_initialize()...\n");
    
    // Given a system fixture
    system_fixture_t *own_fixture = ar_system_fixture_create("init_test");
    assert(own_fixture != NULL);
    
    // When we initialize the test environment
    bool result = ar_system_fixture_initialize(own_fixture);
    ...
    printf("ar_system_fixture_initialize() tests passed!\n");
}

static void test_fixture_register_method(void) {
    printf("Testing ar_system_fixture_register_method()...\n");
    
    // Given an initialized system fixture
    system_fixture_t *own_fixture = ar_system_fixture_create("register_test");
    assert(own_fixture != NULL);
    
    bool init_result = ar_system_fixture_initialize(own_fixture);
    ...
    printf("ar_system_fixture_register_method() tests passed!\n");
}

static void test_fixture_reset_system(void) {
    printf("Testing ar_system_fixture_reset_system()...\n");
    
    // Given an initialized system fixture
    system_fixture_t *own_fixture = ar_system_fixture_create("reset_test");
    assert(own_fixture != NULL);
    ...
    printf("ar_system_fixture_reset_system() tests passed!\n");
}

static void test_fixture_check_memory(void) {
    printf("Testing ar_system_fixture_check_memory()...\n");
    
    // Given an initialized system fixture
    system_fixture_t *own_fixture = ar_system_fixture_create("memory_test");
    assert(own_fixture != NULL);
    ...
    bool result = ar_system_fixture_check_memory(own_fixture);
    ...
    printf("ar_system_fixture_check_memory() tests passed!\n");
}
