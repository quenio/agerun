...
static void test_string_literal(void) {
    ...
    ar_expression_context_t *ctx = ar_expression__create_context(NULL, NULL, NULL, expr);
    assert(ctx != NULL);
...
static void test_memory_access(void) {
    ...
    ar_data_t *user_preferences = ar_data__create_map();
    ...
    ar_data_t *system_limits = ar_data__create_map();
    ...
    ar_data_t *payload = ar_data__create_map();
    assert(payload != NULL);
    ...
    // Test simple memory access
    {
        ...
        // Create expression context
        ar_expression_context_t *ctx = ar_expression__create_context(memory, context, message, expr);
        assert(ctx != NULL);
...
static void test_function_call_expression(void) {
    ...
    // Create expression context
    ar_expression_context_t *ctx2 = ar_expression__create_context(NULL, NULL, NULL, expr2);
    assert(ctx2 != NULL);
