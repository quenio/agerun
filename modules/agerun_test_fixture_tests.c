...
static void test_fixture_create_destroy(void) {
    printf("Testing ar_test_fixture_create() and ar_test_fixture_destroy()...\n");
    
    // Given a test name
    const char *test_name = "sample_test";
    
    // When we create a test fixture
    ...
    const char *retrieved_name = ar_test_fixture_get_name(own_fixture);
    ...
    printf("ar_test_fixture_create() and ar_test_fixture_destroy() tests passed!\n");
}

static void test_fixture_initialize(void) {
    printf("Testing ar_test_fixture_initialize()...\n");
    
    // Given a test fixture
    test_fixture_t *own_fixture = ar_test_fixture_create("init_test");
    assert(own_fixture != NULL);
    
    // When we initialize the test environment
    bool result = ar_test_fixture_initialize(own_fixture);
    ...
    printf("ar_test_fixture_initialize() tests passed!\n");
}

static void test_fixture_verify_directory(void) {
    printf("Testing ar_test_fixture_verify_directory()...\n");
    
    // Given a test fixture
    test_fixture_t *own_fixture = ar_test_fixture_create("dir_test");
    assert(own_fixture != NULL);
    
    // When we verify the directory
    bool result = ar_test_fixture_verify_directory(own_fixture);
    ...
    printf("ar_test_fixture_verify_directory() tests passed!\n");
}

static void test_fixture_check_memory(void) {
    printf("Testing ar_test_fixture_check_memory()...\n");
    
    // Given an initialized test fixture
    test_fixture_t *own_fixture = ar_test_fixture_create("memory_test");
    assert(own_fixture != NULL);
    
    bool init_result = ar_test_fixture_initialize(own_fixture);
    assert(init_result == true);
    
    // When we check memory (before any allocations)
    bool result = ar_test_fixture_check_memory(own_fixture);
    ...
    printf("ar_test_fixture_check_memory() tests passed!\n");
}

int main(void) {
    printf("Running test fixture tests...\n\n");
