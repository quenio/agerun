#ifndef AGERUN_ASSERT_H
#define AGERUN_ASSERT_H

#include <assert.h>

/**
 * Assertion utilities for the AgeRun system.
 * 
 * This module provides:
 * - General purpose assertion macros for runtime validation
 * - Ownership validation macros to enforce memory management rules
 * - All assertions are conditionally compiled using the DEBUG macro,
