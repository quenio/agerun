...
bool ar_instruction_evaluator__evaluate(
    ...
    switch (type) {
        ...
        case AR_INSTRUCTION_AST_TYPE__COMPILE:
            // Delegate to the compile instruction evaluator instance (with frame)
            return ar_compile_instruction_evaluator__evaluate(
