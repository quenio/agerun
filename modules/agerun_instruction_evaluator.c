...
/* Forward declarations for destroy evaluator */
...
static bool _store_result_if_assigned(instruction_evaluator_t *mut_evaluator, const instruction_ast_t *ref_ast, data_t *own_result);
