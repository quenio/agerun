...
bool ar_parse_instruction_evaluator__evaluate(
    ...
    ar_data_t *template_result = ar_expression_evaluator__evaluate_with_frame(mut_evaluator->ref_expr_evaluator, ref_frame, ref_template_ast);
    ...
    ar_data_t *input_result = ar_expression_evaluator__evaluate_with_frame(mut_evaluator->ref_expr_evaluator, ref_frame, ref_input_ast);
