#ifndef AGERUN_HEAD_INSTRUCTION_PARSER_H
#define AGERUN_HEAD_INSTRUCTION_PARSER_H
...
/**
 * Opaque parser structure for head instructions.
 */
typedef struct ar_head_instruction_parser_s ar_head_instruction_parser_t;

/**
 * Create a new head instruction parser instance.
...
/**
 * Destroy a head instruction parser instance.
 ...
 * @return Parsed head AST node (owned by caller), or NULL on failure
...
#endif /* AGERUN_HEAD_INSTRUCTION_PARSER_H */
