 ...
 */
static char* _extract_argument(ar_send_instruction_parser_t *mut_parser, const char *str, size_t *pos, char delimiter) {
    size_t start = *pos;
    int paren_depth = 0;
    ...
    /* Check for empty argument (e.g., "send(1,)") */
 ...
 */
static bool _parse_arguments(ar_send_instruction_parser_t *mut_parser, const char *str, size_t *pos, char ***out_args, size_t *out_count, size_t expected_count) {
 ...
 */
static ar_list_t* _parse_arguments_to_asts(ar_send_instruction_parser_t *mut_parser, 
                                        char **ref_args, 
                                        size_t arg_count,
                                        size_t error_offset) {
