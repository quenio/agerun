 ...
 */
static void _set_error(ar_send_instruction_parser_t *mut_parser, const char *error, size_t position) {
    if (!mut_parser) {
        return;
    }
 ...
 */
static void _clear_error(ar_send_instruction_parser_t *mut_parser) {
    if (!mut_parser) {
        return;
    }
 ...
 */
static list_t* _parse_arguments_to_asts(ar_send_instruction_parser_t *mut_parser, 
                                        char **ref_args, 
                                        size_t arg_count,
                                        size_t error_offset) {
...
ar_instruction_ast_t* ar_send_instruction_parser__parse(
    ...
    ar_instruction_ast_t *own_ast = ar__instruction_ast__create_function_call(
        AR_INST__SEND, "send", const_args, arg_count, ref_result_path
    );
