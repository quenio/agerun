...
static void test_frame__getters_return_parameters(void) {
    ...
    // Given valid memory, context, and message data
    data_t *own_memory = ar__data__create_map();
    ar__data__set_map_integer(own_memory, "x", 42);
    
    data_t *own_context = ar__data__create_map();
    ar__data__set_map_string(own_context, "agent_id", "123");
    ...
    int x = ar__data__get_map_integer(ref_memory, "x");
    if (x != 42) {
    ...
    const char *agent_id = ar__data__get_map_string(ref_context, "agent_id");
    ...
    const char *msg = ar__data__get_string(ref_message);
