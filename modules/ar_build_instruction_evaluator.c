...
static void _log_error(ar_build_instruction_evaluator_t *mut_evaluator, const char *message) {
...
bool ar_build_instruction_evaluator__evaluate(
    ...
    ar_data_t *values_result = ar_expression_evaluator__evaluate(mut_expr_evaluator, ref_frame, ref_values_ast);
