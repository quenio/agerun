...
static void test_fixture__create_destroy(void) {
    ...
    ar_instruction_evaluator_fixture_t *fixture = 
        ar_instruction_evaluator_fixture__create(test_name);
    
    // Then it should be created successfully
    assert(fixture != NULL);
    
    // And all components should be available
    assert(ar_instruction_evaluator_fixture__get_expression_evaluator(fixture) != NULL);
    assert(ar_instruction_evaluator_fixture__get_memory(fixture) != NULL);
    assert(ar_instruction_evaluator_fixture__get_log(fixture) != NULL);
...
static void test_fixture__create_frame(void) {
    // Given a fixture
    ar_instruction_evaluator_fixture_t *fixture = 
        ar_instruction_evaluator_fixture__create("test_frame");
    assert(fixture != NULL);
...
static void test_fixture__create_assignment_int(void) {
    // Given a fixture
    ar_instruction_evaluator_fixture_t *fixture = 
        ar_instruction_evaluator_fixture__create("test_int_assignment");
    assert(fixture != NULL);
...
static void test_fixture__memory_leak_detection(void) {
    // Given a fixture
    ar_instruction_evaluator_fixture_t *fixture = 
        ar_instruction_evaluator_fixture__create("test_memory");
    assert(fixture != NULL);
    ...
    bool no_leaks = ar_instruction_evaluator_fixture__check_memory(fixture);
