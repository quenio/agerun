/**
 * @file ar_create_instruction_evaluator.h
 * @brief Public interface for the create instruction evaluator module
 *
 * This module is responsible for evaluating create instructions (create()).
 * It handles agent creation with methods and context.
 */

#ifndef AGERUN_CREATE_INSTRUCTION_EVALUATOR_H
#define AGERUN_CREATE_INSTRUCTION_EVALUATOR_H
...
typedef struct ar_create_instruction_evaluator_s ar_create_instruction_evaluator_t;

/**
 * Creates a new create instruction evaluator instance
...
/**
 * Destroys a create instruction evaluator instance
...
/**
 * Evaluates a create instruction using frame-based execution
...
#endif /* AGERUN_CREATE_INSTRUCTION_EVALUATOR_H */
