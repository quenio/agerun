...
static void test_fixture_create_destroy(void) {
    printf("Testing ar_method_fixture__create() and ar_method_fixture__destroy()...\n");
    ...
    const char *retrieved_name = ar_method_fixture__get_name(own_fixture);
    ...
    printf("ar_method_fixture__create() and ar_method_fixture__destroy() tests passed!\n");
}
...
static void test_fixture_initialize(void) {
    ...
    bool result = ar_method_fixture__initialize(own_fixture);
    ...
    printf("ar_method_fixture__initialize() tests passed!\n");
}
...
static void test_fixture_verify_directory(void) {
    ...
    bool result = ar_method_fixture__verify_directory(own_fixture);
    ...
    printf("ar_method_fixture__verify_directory() tests passed!\n");
}
...
static void test_fixture_check_memory(void) {
    ...
    bool result = ar_method_fixture__check_memory(own_fixture);
    ...
    printf("ar_method_fixture__check_memory() tests passed!\n");
}
