...
static void test_path_count_normal(void) {
    printf("Testing ar_string__path_count() with normal paths...\n");
    ...
    size_t count1 = ar_string__path_count(ref_path1, '.');
    size_t count2 = ar_string__path_count(ref_path2, '.');
    size_t count3 = ar_string__path_count(ref_path3, '.');
    size_t count4 = ar_string__path_count(ref_path4, '.');
    ...
    printf("ar_string__path_count() normal paths test passed!\n");
}

static void test_path_count_edge_cases(void) {
    printf("Testing ar_string__path_count() with edge cases...\n");
    ...
    // When the path_count function is called
    size_t empty_count = ar_string__path_count(ref_empty, '.');
    size_t null_count = ar_string__path_count(ref_null_ptr, '.');
    size_t only_separators_count = ar_string__path_count(ref_only_separators, '.');
    size_t trailing_count = ar_string__path_count(ref_trailing_separator, '.');
    size_t leading_count = ar_string__path_count(ref_leading_separator, '.');
    ...
    printf("ar_string__path_count() edge cases test passed!\n");
}

static void test_path_segment_normal(void) {
    printf("Testing ar_string__path_segment() with normal cases...\n");
    ...
    char *own_segment0 = ar_string__path_segment(ref_path, '.', 0);
    char *own_segment1 = ar_string__path_segment(ref_path, '.', 1);
    char *own_segment2 = ar_string__path_segment(ref_path, '.', 2);
    ...
    printf("ar_string__path_segment() normal cases test passed!\n");
}

static void test_path_segment_edge_cases(void) {
    printf("Testing ar_string__path_segment() with edge cases...\n");
    ...
    char *own_empty_result = ar_string__path_segment(ref_empty, '.', 0);
    char *own_null_result = ar_string__path_segment(ref_null_ptr, '.', 0);
    char *own_out_of_bounds = ar_string__path_segment("key.value", '.', 5);
    ...
    char *own_empty_seg1 = ar_string__path_segment(ref_path_with_empties, '.', 0);
    char *own_empty_seg2 = ar_string__path_segment(ref_path_with_empties, '.', 1);
    char *own_key_seg = ar_string__path_segment(ref_path_with_empties, '.', 2);
    ...
    printf("ar_string__path_segment() edge cases test passed!\n");
}

static void test_path_parent_normal(void) {
    printf("Testing ar_string__path_parent() with normal paths...\n");
    ...
    char *own_parent1 = ar_string__path_parent(ref_path1, '.');
    char *own_parent2 = ar_string__path_parent(ref_path2, '.');
    char *own_parent3 = ar_string__path_parent(ref_path3, '.');
    ...
    printf("ar_string__path_parent() normal paths test passed!\n");
}

static void test_path_parent_edge_cases(void) {
    printf("Testing ar_string__path_parent() with edge cases...\n");
    ...
    char *own_empty_result = ar_string__path_parent(ref_empty, '.');
    char *own_null_result = ar_string__path_parent(ref_null_ptr, '.');
    char *own_single_segment_result = ar_string__path_parent(ref_single_segment, '.');
    char *own_leading_separator_result = ar_string__path_parent(ref_leading_separator, '.');
    char *own_trailing_separator_result = ar_string__path_parent(ref_trailing_separator, '.');
    char *own_only_separators_result = ar_string__path_parent(ref_only_separators, '.');
    ...
    printf("ar_string__path_parent() edge cases test passed!\n");
}
