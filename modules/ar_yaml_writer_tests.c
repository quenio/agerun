...
static void test_yaml_writer__write_simple_string_to_file(void) {
    ...
    bool result = ar_yaml_writer__write_to_file(own_data, test_file);
...
static void test_yaml_writer__write_map_to_file(void) {
    ...
    bool result = ar_yaml_writer__write_to_file(own_map, test_file);
...
static void test_yaml_writer__write_list_to_file(void) {
    ...
    bool result = ar_yaml_writer__write_to_file(own_list, test_file);
...
static void test_yaml_writer__write_nested_structure(void) {
    ...
    bool result = ar_yaml_writer__write_to_file(own_root, test_file);
