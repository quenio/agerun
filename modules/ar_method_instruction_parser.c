 ...
 */
static void _clear_error(ar_method_instruction_parser_t *mut_parser) {
 ...
 */
static void _set_error(ar_method_instruction_parser_t *mut_parser, const char *ref_message, size_t position) {
 ...
 */
static list_t* _parse_arguments_to_asts(ar_method_instruction_parser_t *mut_parser, 
                                        char **ref_args, 
                                        size_t arg_count,
                                        size_t error_offset) {
...
ar_instruction_ast_t* ar_method_instruction_parser__parse(
    ...
    ar_instruction_ast_t *own_ast = ar_instruction_ast__create_function_call(
        AR_INST__METHOD, "method", const_args, arg_count, ref_result_path
    );
