...
static void test_fixture_create_destroy(void) {
    printf("Testing ar_system_fixture__create() and ar_system_fixture__destroy()...\n");
    ...
    const char *retrieved_name = ar_system_fixture__get_name(own_fixture);
    ...
    printf("ar_system_fixture__create() and ar_system_fixture__destroy() tests passed!\n");
}
...
static void test_fixture_initialize(void) {
    ...
    bool result = ar_system_fixture__initialize(own_fixture);
    ...
    printf("ar_system_fixture__initialize() tests passed!\n");
}
...
static void test_fixture_register_method(void) {
    ...
    printf("ar_system_fixture__register_method() tests passed!\n");
}
...
static void test_fixture_reset_system(void) {
    ...
    printf("ar_system_fixture__reset_system() tests passed!\n");
}
...
static void test_fixture_check_memory(void) {
    ...
    bool result = ar_system_fixture__check_memory(own_fixture);
    ...
    printf("ar_system_fixture__check_memory() tests passed!\n");
}
