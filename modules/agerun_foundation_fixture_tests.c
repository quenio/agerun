...
static void test_fixture_create_destroy(void) {
    printf("Testing ar_foundation_fixture_create() and destroy()...\n");
    
    // Given a test name
    const char *test_name = "sample_foundation_test";
    
    // When we create a foundation fixture
    foundation_fixture_t *own_fixture = ar_foundation_fixture_create(test_name);
    
    // Then the fixture should be created successfully
    assert(own_fixture != NULL);
    
    // And we should be able to get the test name
    const char *retrieved_name = ar_foundation_fixture_get_name(own_fixture);
...
static void test_expression_context_creation(void) {
    ...
    foundation_fixture_t *own_fixture = ar_foundation_fixture_create("expr_test");
    assert(own_fixture != NULL);
...
static void test_custom_expression_context(void) {
    ...
    // Given a foundation fixture and custom data
    foundation_fixture_t *own_fixture = ar_foundation_fixture_create("custom_expr");
    assert(own_fixture != NULL);
    ...
    expression_context_t *ref_ctx = ar_foundation_fixture_create_custom_expression_context(
...
static void test_map_creation(void) {
    ...
    // Given a foundation fixture
    foundation_fixture_t *own_fixture = ar_foundation_fixture_create("map_test");
    assert(own_fixture != NULL);
...
static void test_list_creation(void) {
    ...
    // Given a foundation fixture
    foundation_fixture_t *own_fixture = ar_foundation_fixture_create("list_test");
    assert(own_fixture != NULL);
    
    // When we create a test list
    data_t *ref_list = ar_foundation_fixture_create_test_list(own_fixture);
...
static void test_resource_tracking(void) {
    ...
    // Given a foundation fixture
    foundation_fixture_t *own_fixture = ar_foundation_fixture_create("tracking_test");
    assert(own_fixture != NULL);
    ...
    ar_foundation_fixture_track_data(own_fixture, own_external_map);
    ...
    ar_foundation_fixture_track_expression_context(own_fixture, own_external_ctx);
...
static void test_memory_check(void) {
    ...
    // Given a foundation fixture
    foundation_fixture_t *own_fixture = ar_foundation_fixture_create("memory_test");
    assert(own_fixture != NULL);
    
    // Create some test resources
    data_t *ref_map = ar_foundation_fixture_create_test_map(own_fixture, NULL);
    assert(ref_map != NULL);
    ...
    bool result = ar_foundation_fixture_check_memory(own_fixture);
...
int main(void) {
    printf("Running foundation fixture tests...\n\n");
    ...
    printf("\nAll foundation fixture tests passed!\n");
    return 0;
}
