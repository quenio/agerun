...
- [x] Fix ar_data.h enum values (ar_data_type_t):
  - [x] DATA_INTEGER → AR_DATA_TYPE__INTEGER
  - [x] DATA_DOUBLE → AR_DATA_TYPE__DOUBLE
  - [x] DATA_STRING → AR_DATA_TYPE__STRING
  - [x] DATA_LIST → AR_DATA_TYPE__LIST
  - [x] DATA_MAP → AR_DATA_TYPE__MAP
- [x] Fix ar_event.h enum values (ar_event_type_t):
  - [x] AR_EVENT_ERROR → AR_EVENT_TYPE__ERROR
  - [x] AR_EVENT_WARNING → AR_EVENT_TYPE__WARNING
  - [x] AR_EVENT_INFO → AR_EVENT_TYPE__INFO
- [x] Fix ar_expression_ast.h enum values:
  - [x] ar_expression_ast_type_t values:
    - [x] AR_EXPR__LITERAL_INT → AR_EXPRESSION_AST_TYPE__LITERAL_INT
    - [x] AR_EXPR__LITERAL_DOUBLE → AR_EXPRESSION_AST_TYPE__LITERAL_DOUBLE
    - [x] AR_EXPR__LITERAL_STRING → AR_EXPRESSION_AST_TYPE__LITERAL_STRING
    - [x] AR_EXPR__MEMORY_ACCESS → AR_EXPRESSION_AST_TYPE__MEMORY_ACCESS
    - [x] AR_EXPR__BINARY_OP → AR_EXPRESSION_AST_TYPE__BINARY_OP
  - [x] ar_binary_operator_t values:
    - [x] AR_OP__ADD → AR_BINARY_OPERATOR__ADD
    - [x] AR_OP__SUBTRACT → AR_BINARY_OPERATOR__SUBTRACT
    - [x] AR_OP__MULTIPLY → AR_BINARY_OPERATOR__MULTIPLY
    - [x] AR_OP__DIVIDE → AR_BINARY_OPERATOR__DIVIDE
    - [x] AR_OP__EQUAL → AR_BINARY_OPERATOR__EQUAL
    - [x] AR_OP__NOT_EQUAL → AR_BINARY_OPERATOR__NOT_EQUAL
    - [x] AR_OP__LESS → AR_BINARY_OPERATOR__LESS
    - [x] AR_OP__LESS_EQ → AR_BINARY_OPERATOR__LESS_EQ
    - [x] AR_OP__GREATER → AR_BINARY_OPERATOR__GREATER
    - [x] AR_OP__GREATER_EQ → AR_BINARY_OPERATOR__GREATER_EQ
- [x] Fix ar_instruction.h enum values (ar_instruction_type_t):
  - [x] INST_ASSIGNMENT → AR_INSTRUCTION_TYPE__ASSIGNMENT
  - [x] INST_SEND → AR_INSTRUCTION_TYPE__SEND
  - [x] INST_IF → AR_INSTRUCTION_TYPE__IF
  - [x] INST_METHOD → AR_INSTRUCTION_TYPE__METHOD
  - [x] INST_AGENT → AR_INSTRUCTION_TYPE__AGENT
  - [x] INST_DESTROY → AR_INSTRUCTION_TYPE__DESTROY
  - [x] INST_PARSE → AR_INSTRUCTION_TYPE__PARSE
- [x] Fix ar_instruction_ast.h enum values (ar_instruction_ast_type_t):
  - [x] AR_INST__ASSIGNMENT → AR_INSTRUCTION_AST_TYPE__ASSIGNMENT
  - [x] AR_INST__SEND → AR_INSTRUCTION_AST_TYPE__SEND
  - [x] AR_INST__IF → AR_INSTRUCTION_AST_TYPE__IF
  - [x] AR_INST__METHOD → AR_INSTRUCTION_AST_TYPE__METHOD
  - [x] AR_INST__AGENT → AR_INSTRUCTION_AST_TYPE__AGENT
  - [x] AR_INST__DESTROY_AGENT → AR_INSTRUCTION_AST_TYPE__DESTROY_AGENT
  - [x] AR_INST__DESTROY_METHOD → AR_INSTRUCTION_AST_TYPE__DESTROY_METHOD
  - [x] AR_INST__PARSE → AR_INSTRUCTION_AST_TYPE__PARSE
  - [x] AR_INST__BUILD → AR_INSTRUCTION_AST_TYPE__BUILD
- [x] Fix ar_io.h enum values (ar_file_result_t):
  - [x] FILE_SUCCESS → AR_FILE_RESULT__SUCCESS
  - [x] FILE_ERROR_OPEN → AR_FILE_RESULT__ERROR_OPEN
  - [x] FILE_ERROR_READ → AR_FILE_RESULT__ERROR_READ
  - [x] FILE_ERROR_WRITE → AR_FILE_RESULT__ERROR_WRITE
  - [x] FILE_ERROR_PERMISSIONS → AR_FILE_RESULT__ERROR_PERMISSIONS
  - [x] FILE_ERROR_NOT_FOUND → AR_FILE_RESULT__ERROR_NOT_FOUND
  - [x] FILE_ERROR_CORRUPT → AR_FILE_RESULT__ERROR_CORRUPT
  - [x] FILE_ERROR_ALREADY_EXISTS → AR_FILE_RESULT__ERROR_ALREADY_EXISTS
