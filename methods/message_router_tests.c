...
static void test_message_router_routing(void) {
    ...
    // Create test fixture
    test_fixture_t *own_fixture = ar_test_fixture_create("message_router_routing");
    ...
    assert(ar_test_fixture_load_method(own_fixture, "message-router", "../methods/message-router-1.0.0.method", "1.0.0"));
