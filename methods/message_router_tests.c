...
static void test_message_router_routing(void) {
    ...
    ar_system__process_next_message(); // router wake
    ar_system__process_next_message(); // echo wake
    ...
    bool sent = ar_agency__send_to_agent(router_agent, own_message);
    assert(sent);
    ...
    sent = ar_agency__send_to_agent(router_agent, own_message2);
    assert(sent);
    ...
    sent = ar_agency__send_to_agent(router_agent, own_message3);
    assert(sent);
