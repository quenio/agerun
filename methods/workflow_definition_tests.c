...
static void test_workflow_definition__shared_model_path_uses_passwd_home_when_home_unset(void) {
    char own_model_path[PATH_MAX];
    ...
    printf("Testing workflow-definition shared model path uses passwd home when HOME is unset...\n");
...
int main(void) {
    ...
    test_workflow_definition__shared_model_path_uses_passwd_home_when_home_unset();
