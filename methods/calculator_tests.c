...
static void test_calculator_add(void) {
    ...
    // Create test fixture
    test_fixture_t *own_fixture = ar_test_fixture_create("calculator_add");
    ...
    assert(ar_test_fixture_load_method(own_fixture, "calculator", "../methods/calculator-1.0.0.method", "1.0.0"));
...
static void test_calculator_multiply(void) {
    ...
    // Create test fixture
    test_fixture_t *own_fixture = ar_test_fixture_create("calculator_multiply");
    assert(own_fixture != NULL);
    ...
    assert(result != NULL);
    assert(ar_data_get_type(result) == DATA_INTEGER);
    assert(ar_data_get_integer(result) == 10);
...
static void test_calculator_subtract(void) {
    ...
    // Create test fixture
    test_fixture_t *own_fixture = ar_test_fixture_create("calculator_subtract");
    assert(own_fixture != NULL);
    ...
    int subtract_result = ar_data_get_integer(result);
...
static void test_calculator_divide(void) {
    ...
    // Create test fixture
    test_fixture_t *own_fixture = ar_test_fixture_create("calculator_divide");
    assert(own_fixture != NULL);
    ...
    int divide_result = ar_data_get_integer(result);
...
static void test_calculator_unknown_operation(void) {
    ...
    // Create test fixture
    test_fixture_t *own_fixture = ar_test_fixture_create("calculator_unknown");
    assert(own_fixture != NULL);
    ...
    int unknown_result = ar_data_get_integer(result);
