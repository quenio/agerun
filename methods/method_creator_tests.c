...
static void test_method_creator_create_simple(void) {
    ...
    ar__data__set_map_string(own_message, "method_name", "doubler");
    ar__data__set_map_string(own_message, "instructions", "memory.result := message.value * 2\nsend(message.sender, memory.result)");
    ar__data__set_map_string(own_message, "version", "1.0.0");
    ar__data__set_map_integer(own_message, "sender", 888);
    ...
    if (result == NULL) {
        ...
        int result_val = ar__data__get_integer(result);
...
static void test_method_creator_invalid_syntax(void) {
    ...
    ar__data__set_map_string(own_message, "method_name", "broken");
    ar__data__set_map_string(own_message, "instructions", "memory.result = invalid syntax here");
    ar__data__set_map_string(own_message, "version", "1.0.0");
    ar__data__set_map_integer(own_message, "sender", 888);
