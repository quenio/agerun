...
```
Agent: "step-verifier"
Prompt: "Verify Step N: [Step Title] completion for compact-changes command.

Todo Item: [Description of what the step accomplished]
Command File: .opencode/command/ar/compact-changes.md
...
- Add todo item: "Step 2: Analyze Patterns" - Status: pending
- Add todo item: "Verify Step 2: Analyze Patterns" - Status: pending
...
- Add todo item: "Step 6: Update TODO" - Status: pending
- Add todo item: "Verify Step 6: Update TODO" - Status: pending
- Add todo item: "Step 7: Commit Changes" - Status: pending
- Add todo item: "Verify Step 7: Commit Changes" - Status: pending
- Add todo item: "Verify Complete Workflow: compact-changes" - Status: pending
